...
#define XUSBPS_REQ_REPLY_LEN		(2048 * 2)	/**< Max size of reply buffer. */
...
#define XUSBPS_TYPE_HID_REPORT_DESCRIPTOR  0x22
...
#define XUSBPS_CLASSREQ_HID_GET_REPORT	0x01
#define XUSBPS_CLASSREQ_HID_SET_REPORT	0x09
